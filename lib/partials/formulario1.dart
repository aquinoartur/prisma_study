...
class FormularioScreen1 extends StatefulWidget {

  @override
  _FormularioScreen1 createState() => _FormularioScreen1();
}

class _FormularioScreen1 extends State<FormularioScreen1> {
                ...
                TextFormField(
                 ...
                 // onSaved: (link) => url.url1 = link,
                  onSaved: (link) {
                    setState(() {
                      Firestore.instance
                          .collection('quizlinks')
                          .document('4JvlRkjH1jbjyFfMuSrs')
                          .updateData({'url1': link});
                    });
                  },
